...
public class VNPayService {
    public Message createOrder(int total, String orderInfor, String urlReturn){
        System.out.println("test :"+ total + orderInfor);
        ...
        Data data = new Data.Builder(null).withResults(paymentUrl).build();
