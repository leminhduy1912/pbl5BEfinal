...
import static com.pbl5.utils.constants.Endpoint.CUSTOMER;
import static com.pbl5.utils.constants.Endpoint.V1;

@WebServlet(urlPatterns = {V1 + "/booking/find-by-user-id"})
@MultipartConfig
public class FindByUserIdController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ErrorHandler.handle(resp, () -> bookingService.findByUserId(booking));
    }
}
