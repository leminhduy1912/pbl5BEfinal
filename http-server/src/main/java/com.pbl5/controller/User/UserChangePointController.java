...
@WebServlet(urlPatterns = {V1 + "/user-change-point"})
@MultipartConfig
public class UserChangePointController extends HttpServlet {
...
//        System.out.println();
        ErrorHandler.handle(resp, () -> userService.updatePoint(dto));
    }
}
