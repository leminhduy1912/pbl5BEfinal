...
@WebServlet(urlPatterns = {V1 + "/promotion/image"})
public class PromotionImageController extends HttpServlet {
    private IPromotionService promotionService = new PromotionService();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ErrorHandler.handle(resp, () -> promotionService.findAllImage());
    }
}
