...
@WebServlet(urlPatterns = {V1 + "/showtime/find-by-name"})
@MultipartConfig
public class FindByMovieNameController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ErrorHandler.handle(resp, () -> showTimeService.findByDateShowAndMovieNameAndStatus(showTime));
    }
}
